...
print(test_string)
previous_n =  test_string[0:n-1]
foreward_n = test_string[n:len(test_string)]
new_string = previous_n + foreward_n
print(new_string)
...
my_string_2 = "How many times is the letter e in this string?"

# Insert code below
count = 0
for i in range(len(my_string_2)):
    if my_string_2[i] == 'e':
        count = count + 1
print(count)
